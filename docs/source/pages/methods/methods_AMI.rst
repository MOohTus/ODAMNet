...
- Define target genes as active genes and search active modules (AM)
- Active module is composed of target genes and other linked genes
- Then, performs an overlap analysis between each AM identified and pathways of interest
- We extend the target list and find **indirect associations** with diseases.
