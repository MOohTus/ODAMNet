...
Target genes are coming from Balmer and Blomhoff [2]_. Pathways of interests are coming from Reactome [4]_ and
WikiPathways [3]_ and processes of interest are coming from Biological Process (GO) [5]_:sup:`,` [6]_.
...
Target genes are coming from Balmer and Blomhoff [2]_. There are **521 vitamin A target genes**.
...
.. [2] Balmer JE & Blomhoff R. Gene expression regulation by retinoic acid. Journal of lipid research. 2002.
.. [3] Martens M, Ammar A, Riutta A *et al.*. WikiPathways: connecting communities. Nucleic acids research. 2021.
.. [4] Jassal B, Matthews L, Viteri G *et al.*. The reactome pathway knowledgebase. Nucleic acids research. 2020.
.. [5] The Gene Ontology Consortium. The Gene Ontology resource: enriching a GOld mine. Nucleic acids research. 2021.
.. [6] Ashburner M, Ball CA, Blake JA *et al.*. Gene ontology: tool for the unification of biology. Nature Genetics. 2000.
.. [7] Pratt D, Chen J, Welker *et al.*. NDEx, the Network Data Exchange. Cell Systems. 2015.
...
.. [11] Ozisik O, Térézol M & Baudot A. orsum: a Python package for filtering and comparing enrichment analyses using a simple principle. BMC bioinformatics. 2022.
