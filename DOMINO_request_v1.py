...
url = 'https://www.ebi.ac.uk/spot/oxo/api/terms/'
params = {'term_id': 'DOID:162'}
...
json_payload = {"resourceType": "Appointment"}
response = requests.post(url=url, params=params, json=json_payload, headers=headers)
response.json()
